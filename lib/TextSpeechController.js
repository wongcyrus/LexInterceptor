...
class TextSpeechController {
    ...
    constructor(attachmentBucket) {
        ...
        this.storageController = new StorageController(attachmentBucket);
    }
    ...
    getSpeech(messagingEvent) {
        ...
        return this._getPollyLanguageCodes()
            .then(pollyVoices => new Promise((resolve, reject) => {
                    ...
                    let pollyVoiceLanguage = pollyVoices.filter(v => v.LanguageCode.substring(0, 1) === messagingEvent.message.language.substring(0, 1));
    ...
    _getResponsiveVoiceSpeech(messagingEvent) {
        ...
        return this.storageController.downloadToTmp(
            `https://responsivevoice.org/responsivevoice/getvoice.php?t=${urlText}&tl=${messagingEvent.message.language}`,
            messagingEvent.Key);
    }
