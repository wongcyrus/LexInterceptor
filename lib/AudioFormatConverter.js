...
class AudioConverter {
    ...
    convertToLinear16(context) {
        ...
        return AudioConverter._setupffmpeg()
    ...
    _toLinear16(context) {
        ...
        let filePathOut = context.filePathName.split("?")[0]
            .replace(".mp4", ".flac")
            .replace(".oga", ".flac")
            .replace(".aac", ".flac");
        return new Promise((resolve, reject) => {
            ...
            if (filePathIn.indexOf('.mp4') > -1 || filePathIn.indexOf('.aac') > -1 || filePathIn.indexOf('.oga') > -1) {
                try {
                    ffmpeg(filePathIn)
