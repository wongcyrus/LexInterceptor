...
aws lambda update-function-code --function-name LexInterceptor-FacebookLexProxy-TUB2RGDX45MJ --s3-bucket howwhofeelinvideopackage --s3-key LexInterceptor_latest.zip