...
aws lambda update-function-code --function-name LexInterceptor-FacebookLexInterceptor-1ACUDKDJL6ZON --s3-bucket howwhofeelinvideopackage --s3-key LexInterceptor_latest.zip