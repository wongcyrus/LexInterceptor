...
aws lambda update-function-code --function-name LexInterceptor-FacebookLexInterceptorFunction-76LX7JP2MD0Y --s3-bucket howwhofeelinvideopackage --s3-key LexInterceptor_latest.zip